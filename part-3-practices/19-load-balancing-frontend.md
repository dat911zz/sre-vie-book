...
Hãy bắt đầu bằng cách xem xét hai kịch bản traffic phổ biến: một yêu cầu tìm kiếm cơ bản và một yêu cầu tải video (upload). Người dùng muốn nhận kết quả truy vấn nhanh chóng, nên biến quan trọng nhất cho yêu cầu tìm kiếm là độ trễ (latency). Mặt khác, người dùng chấp nhận việc upload video mất một khoảng thời gian không thể bỏ qua, nhưng cũng muốn những yêu cầu đó thành công ngay lần đầu, nên biến quan trọng nhất cho video upload là thông lượng (throughput). Những nhu cầu khác nhau của hai loại yêu cầu này đóng vai trò trong cách chúng tôi xác định sự phân phối tối ưu cho mỗi yêu cầu ở cấp *toàn cầu*:
...
-   Luồng video upload được định tuyến qua một đường khác — có thể đến một liên kết hiện đang bị khai thác dưới — để tối đa hóa thông lượng với chi phí của độ trễ.
