...
-   Luồng video upload được định tuyến qua một đường khác — có thể đến một liên kết hiện đang được sử dụng dưới mức — để tối đa hóa thông lượng với chi phí của độ trễ.
