...
Chúng tôi triển khai nhiều replica của dịch vụ cron và sử dụng thuật toán nhất trí phân tán Paxos (xem [Quản lý Trạng thái Quan trọng: Nhất trí Phân tán cho Độ tin cậy](https://sre.google/sre-book/managing-critical-state/)) để đảm bảo chúng có trạng thái nhất quán. Cho đến khi đa số các thành viên trong nhóm khả dụng, hệ thống phân tán xét về tổng thể có thể xử lý thành công các thay đổi trạng thái mới bất chấp sự cố của các tập con bị giới hạn của hạ tầng.
