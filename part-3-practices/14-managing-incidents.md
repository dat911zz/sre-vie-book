...
Bạn chằm chằm nhìn vào các log (nhật ký) trong khoảng thời gian tưởng chừng như cả một thế kỷ. Hàng nghìn dòng log gợi ý có một lỗi trong một trong các module vừa được cập nhật gần đây, nên bạn quyết định hoàn tác (revert) các server về release (phát hành) trước đó. Khi thấy rollback không giúp gì, bạn gọi cho Josephine, người đã viết phần lớn code cho dịch vụ đang "chảy máu" này. Nhắc rằng ở múi giờ của cô ấy đã 3:30 sáng, cô lờ mờ đồng ý đăng nhập xem qua. Các đồng nghiệp Sabrina và Robin bắt đầu "chọc" quanh từ các terminal của riêng họ. "Chỉ đang nhìn thôi," họ nói với bạn.

Giờ đây một trong những ông/bà "bộ vest" đã gọi cho sếp bạn, nóng giận đòi biết lý do vì sao ông ấy không được thông báo về "sự sụp đổ hoàn toàn của dịch vụ quan trọng này". Một cách độc lập, các phó tổng giám đốc (vice president) cũng thúc giục bạn đưa ra ETA (ước tính thời gian hoàn thành), lặp đi lặp lại hỏi "Làm sao điều này có thể xảy ra được?". Bạn muốn thông cảm, nhưng làm vậy sẽ đòi hỏi sự tập trung mà bạn đang dành dụm cho công việc. Các VP dựa vào kinh nghiệm kỹ thuật trước đó và đưa ra những bình luận không liên quan nhưng khó bác bỏ như "Tăng kích thước trang (page) bộ nhớ đi!".
...
Xem [Example Incident State Document](https://sre.google/sre-book/incident-document/) để có một tài liệu incident mẫu. Tài liệu sống này có thể bừa bộn, nhưng phải hữu dụng. Dùng một template (mẫu) giúp tạo tài liệu dễ hơn, và giữ thông tin quan trọng nhất ở đầu giúp tài liệu dễ dùng hơn. Giữ tài liệu này lại để phục vụ phân tích postmortem (báo cáo sau sự cố) và, nếu cần, phân tích ở cấp cao hơn (meta analysis).
