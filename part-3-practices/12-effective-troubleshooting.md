...
-   *Các hệ thống là phức tạp*. Rất có thể có nhiều yếu tố, mỗi yếu tố đơn lẻ không phải là nguyên nhân, nhưng khi xét chung lại thì là nguyên nhân.<sup>[15](#fn15)</sup> Các hệ thống thực cũng thường phụ thuộc vào đường dẫn (path-dependent), nghĩa là chúng phải ở trong một trạng thái cụ thể trước khi một sự cố xảy ra.
