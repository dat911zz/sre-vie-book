...
Điểm chính cần chú ý là trong mỗi vòng, từng backend trong toàn bộ danh sách chỉ được gán cho đúng một client (ngoại trừ vòng cuối, nơi mà chúng tôi đã hết client). Trong ví dụ này, mọi backend được gán cho chính xác hai hoặc ba client.
