...
Các đội SRE được xây dựng sao cho kỹ sư của chúng tôi chia thời gian giữa hai loại công việc có tầm quan trọng như nhau. Các SRE làm on-call, điều này đòi hỏi chúng tôi đặt tay lên các hệ thống, quan sát các hệ thống này hỏng ở đâu và hỏng như thế nào, và hiểu các thách thức như làm thế nào để mở rộng chúng một cách tốt nhất. Nhưng chúng tôi cũng có thời gian để suy ngẫm và quyết định xây dựng điều gì để làm cho những hệ thống đó dễ quản lý hơn. Về bản chất, chúng tôi có niềm vui được đảm nhận cả vai trò của người lái máy bay *và* kỹ sư/thiết kế. Những trải nghiệm của chúng tôi khi vận hành cơ sở hạ tầng tính toán khổng lồ được mã hóa trong mã thực tế và sau đó được đóng gói thành một sản phẩm riêng biệt.
