...
-   Cho phép bin-packing (gói chặt) nhiều instance MySQL trên cùng một machine vật lý: Borg sẽ cho phép sử dụng hiệu quả hơn các tài nguyên machine thông qua container.
