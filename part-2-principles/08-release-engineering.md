...
*Bao gồm các tệp cấu hình và binary trong cùng một gói MPM.* Đối với các dự án có ít tệp cấu hình, hoặc các dự án mà các tệp (hoặc một tập con các tệp) thay đổi với mỗi chu kỳ release, các tệp cấu hình có thể được bao gồm trong gói MPM cùng với các binary. Chiến lược này giới hạn tính linh hoạt vì ràng buộc chặt chẽ binary với các tệp cấu hình, nhưng lại đơn giản hóa việc triển khai vì chỉ cần cài đặt một gói duy nhất.
